...
contact \citep{wrangham2012intergroup}. It could also enable deeper forms of intergroup cooperation, such as trade. So, the capacity for group reciprocity may be a 
stepping stone in the evolution of humans as a cooperative species. 
...
to those groups. Without groups, generalized upstream reciprocity doesn't allow
...
This then gives rise to a standard group selection model, where the group-level
advantages balance out the individual-level costs. Selfish free-riders within
...
bilateral relationships \citep{nowak2007upstream}. 
